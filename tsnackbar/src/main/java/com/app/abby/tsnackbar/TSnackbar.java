...
public final class TSnackbar {
    ...
    /**
     * indicate whether the snack bar is below status bar
     */
    ...
    /**
     * indicate the direction the snack bar shows
     ...
     * @param gravity the Gravity must be one of Gravity.CENTER Gravity.START or Gravity.END
     */
    public TSnackbar setMessageGravity(int gravity){
        mView.getMessageView().setGravity(gravity);
        return this;
    }


    /**
     * set the alpha of the background,the value must be 0 to 255
     */
    ...
    /**
     * set the ifon res and sizes
     * @param iconRes the icon resId
     * @param widpx the width in px
     * @param heipx the height in px
     */
    ...
    public TSnackbar setActionTextSize(float size){
        mView.getActionView().setTextSize(size);
        return this;
    }
    ...
    /**
     * set the height of the snack bar,recommend to be a value greater than 120dp dup to the padding
     * @param height
     * @return
     */
    ...
    /**
     * set the icon res without sizes definition,the default size is 15dp
    ...
    /**
     * set the style of the snack bar
     * @param style see the predefined styles above
     */
